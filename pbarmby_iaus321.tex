...
% MRR comments
%Intro needs a concluding/connecting sentence.
%Because the study is on stellar popÕs, I would suggest to shorten/
%remove things about background/integrated/SBP; and instead, include
%more discussions on point sources, e.g., Britavskiy et al. (2015).
%Also, the ending needs to be wrapped up by a concluding sentence.
